...
__attribute__((section("__versions"))) = {
	...
	{ 0x2079083f, __VMLINUX_SYMBOL_STR(usb_ep_autoconfig_reset) },
	...
	{ 0xf26c5824, __VMLINUX_SYMBOL_STR(usb_add_config_only) },
	...
	{ 0x1d0fa2c9, __VMLINUX_SYMBOL_STR(usb_remove_function) },
};
